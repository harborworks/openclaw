...
export default defineSchema({
    ...
    activities: defineTable({
        type: v.union(v.literal("task_created"), v.literal("task_updated"), v.literal("task_assigned"), v.literal("task_status_changed"), v.literal("message_sent"), v.literal("document_created"), v.literal("agent_status_changed")),
    ...
    documents: defineTable({
        title: v.string(),
        content: v.string(),
        type: v.union(v.literal("deliverable"), v.literal("research"), v.literal("protocol"), v.literal("reference"), v.literal("draft")),
        taskId: v.optional(v.id("tasks")),
    ...
    cronJobs: defineTable({
        ...
        enabled: v.boolean(),
        scheduleKind: v.union(v.literal("every"), v.literal("cron"), v.literal("at")),
